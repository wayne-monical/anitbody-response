...
---
Introduction
An initial study was conducted to measure the antibody response to a new vaccine. A variety of descriptive information was collected alongside this data, and the project was replicated on a new sample of participants a few months later. To better understand the impact of demographic and clinical characteristics on antibody response, a model can be constructed to evaluate and make predictions on future vaccine testing. Different models may be built using the data from the first study, compared to each other so that the best fit may be found, and validated using the data from the second study. 
